    ...
    var JTC = function() {},
        ...
        events = {
            ...
            showSelector: function(flag) {
                ...
                var coord = {
                    x: parseInt($(config.bgDivID).style.left.match(/\d+/g)) + (flag == 1 ? 110 : 60),
                    y: parseInt($(config.bgDivID).style.top.match(/\d+/g)) + 35
                };
        ...
        dialog = function() {
            this.getHeaderPanel = function() {
                var table = util.createTable();
                util.setObjectStyle(table, 'width:100%;margin-top: 10px;');
                var row = table.insertRow(0);
                var cell = row.insertCell(0);
                // padding: 3px 15px;
                util.setObjectStyle(cell, 'padding: 0 17px;');
                // cell.style.width = '30px';
                // cell.style.height = '23px';

                //左箭头
                var leftbnStyle = 'width:0; height:0; border-top: 6px solid transparent; border-right: 11px solid #747473;border-bottom: 6px solid transparent; cursor: pointer;';
                var bn = $$('div');
                bn.id = 'bn_preMonth';
                bn.onclick = function() {
                    events.turnMonth(-1);
                };
                util.setObjectStyle(bn, leftbnStyle);
                cell.appendChild(bn);

                var style = 'cursor:pointer;width:60px; padding:0 10px; line-height:20px;background-color:#FFFFFF;';
                ...
                var rightbnStyle = 'width:0; height:0; border-top: 6px solid transparent; border-left: 11px solid #747473;border-bottom: 6px solid transparent; cursor: pointer;';
                bn = $$('div');
                util.setObjectStyle(bn, rightbnStyle);
                bn.onclick = function() {
                    events.turnMonth(1);
                };

                // bn = util.createButton('>', rightbnStyle, function() {
                //     events.turnMonth(1);
                // });
                cell.appendChild(bn);
            ...
            this.getWeekDayPanel = function() {
                ...
                var style = 'height:35px;color:#767676; border-top:0px; border-bottom:1px solid #CECECE; border-right:0px; border-left:0px;background-color:#FFFFFF;';
                for (var i = 0; i < 7; i++) {
            ...
            this.getBottomPanel = function() {
                ...
                var bnStyle = 'font-size:12px;width:38px; border:0px; background-color:#FFFFFF;outline:none;';
            ...
            var style = 'border:1px solid #CECECE;box-shadow: 2px 2px 5px #CCC;width: 100%;border-radius: 3px; font-size:12px; text-align:center;';
            ...
            _style = 'position:absolute; width:252px; height:220px;z-index:20000; font-size:12px;display:none;background-color:#FFFFFF;';
            util.setObjectStyle(div, _style);

            if (browser.IE && browser.VERSION < 7) {
                var iframe = $$('iframe');
                _style = 'position:absolute; width:252px; height:220px;z-index:-1;';
